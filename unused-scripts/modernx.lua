...
local user_opts = {
    ...
    scaleforcedwindow = 1.6,    -- scaling when rendered on a forced window
    ...
    font = 'Noto Sans',			-- default osc font
    ...
    timems = true,  	   	    -- Display time down to millliseconds by default
